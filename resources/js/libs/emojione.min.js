...
!(function(a) {
  ...
  (a.shortnames = c.join('|')),
    ...
    (a.shortnameToAscii = function(b) {
      var c,
        d = a.objectFlip(a.asciiList);
      return (b = b.replace(a.regShortNames, function(b) {
        return 'undefined' != typeof b &&
        '' !== b &&
        b in a.emojioneList
          ? ((c =
            a.emojioneList[b].unicode[
            a.emojioneList[b].unicode.length - 1
              ]),
            'undefined' != typeof d[c] ? d[c] : b)
          : b;
      }));
    }),
        ...
        (b = b.replace(a.regShortNames, function(b) {
          ...
          b in a.emojioneList
            ? ((c = a.emojioneList[b].unicode[0].toUpperCase()),
              (d = a.emojioneList[b].fname),
              (e = a.emojioneList[b].uc),
              a.convert(e))
            : b;
        })),
        a.ascii &&
        (b = b.replace(a.regAscii, function(b, d, e, f) {
          return 'undefined' != typeof f &&
          '' !== f &&
          a.unescapeHTML(f) in a.asciiList
            ? ((f = a.unescapeHTML(f)),
              (c = a.asciiList[f].toUpperCase()),
            e + a.convert(c))
            : b;
        })),
          b
    ...
    (a.shortnameToImage = function(b) {
      ...
      return (
        (b = b.replace(a.regShortNames, function(b) {
          ...
          b in a.emojioneList
            ? ((d =
              ...
              (f = a.imageTitleTag ? 'title="' + b + '"' : ''),
              (e = a.unicodeAlt ? a.convert(d.toUpperCase()) : b),
              (c =
                'png' === a.imageType
                  ? a.sprites
        ...
        a.ascii &&
        (b = b.replace(a.regAscii, function(b, g, h, i) {
          return 'undefined' != typeof i &&
          '' !== i &&
          a.unescapeHTML(i) in a.asciiList
            ? ((i = a.unescapeHTML(i)),
              (d = a.asciiList[i]),
              (f = a.imageTitleTag
                ? 'title="' + a.escapeHTML(i) + '"'
                : ''),
              (e = a.unicodeAlt
                ? a.convert(d.toUpperCase())
                : a.escapeHTML(i)),
              (c =
                'png' === a.imageType
                  ? a.sprites
    ...
    (a.unicodeToImage = function(b) {
      var c,
        ...
        g,
        h,
        i = a.mapUnicodeToShort();
      return (b = b.replace(a.regUnicode, function(b) {
        return 'undefined' != typeof b && '' !== b && b in a.jsEscapeMap
          ? ((d = a.jsEscapeMap[b]),
            (e = i[d]),
            (f = a.emojioneList[e].fname),
            (g = a.unicodeAlt ? a.convert(d.toUpperCase()) : e),
            (h = a.imageTitleTag ? 'title="' + e + '"' : ''),
            (c =
              'png' === a.imageType
                ? a.sprites
                ? '<span class="emojione emojione-' +
    ...
    (a.mapEmojioneList = function(b) {
      for (var c in a.emojioneList)
        if (a.emojioneList.hasOwnProperty(c))
          for (
            var d = 0, e = a.emojioneList[c].unicode.length;
            e > d;
            d++
          ) {
    ...
    (a.mapUnicodeToShort = function() {
      return (
        ...
        ((a.memMapShortToUnicode = {}),
          a.mapEmojioneList(function(b, c) {
      ...
      if (
        ...
        (a.memMapShortToUnicodeCharacters = {}),
          a.mapEmojioneList(function(c, d) {
            var e = a.convert(c);
            a.emojioneList[d].isCanonical &&
            (a.memMapShortToUnicodeCharacters[e] = d),
              b.push(e);
          }),
